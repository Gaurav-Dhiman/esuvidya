		...
		<form action="<?php echo base_url('student/add');?>" class="form-horizontal form-bordered form-label-stripped" method="POST" enctype="multipart/form-data">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="span3">
						...
						<select name="std" class="m-wrap span12" id="std" required>
					...
					<div class="span3">
						...
						<select name="streams" class="m-wrap span12" id="streams" required disabled="">
					...
					<div class="span3">
						...
						<select name="divisions" class="m-wrap span12" id="divisions" required disabled="">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="span3">
						<label class="control-label">Middle Name</label>
						<input name="father_mname" type="text" placeholder="Middle Name" class="m-wrap span12"  required="required"/>
					</div>
					<div class="span3">
