...
?>
	...
	$(document).ready(function(){
		...
		$('#tbl_viewallstudent').dataTable({
		    ...
		    "bProcessing": true,
		    "bServerSide": true,
		    "sAjaxSource": "<?php echo base_url('student/ajax_datatable_student_by_class_list') ?>",
	...
	<!-- HEADER  -->
	<legend>Student By Class Listing	
...
?>	
	<div class="portlet box blue ">
		...
		<div class="portlet-body form">
			<form action="<?php echo base_url('student/student_by_class_listing');?>" class="form-horizontal form-bordered form-label-stripped" method="POST">
