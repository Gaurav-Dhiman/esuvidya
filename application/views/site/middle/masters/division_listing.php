...
$(document).ready(function(){
	...
	$('#tbl_viewalluser').dataTable({
	    ...
	    "bProcessing": true,
	    "bServerSide": true,
	    "sAjaxSource": "<?php echo base_url('master/ajax_datatable_division_list') ?>",
...
<legend>Section Listing
	<div class="btn-group pull-right">
		...
		<ul class="dropdown-menu">                         
			<li><a onclick="$.ui_redirect('add_division')" href="<?php echo base_url('master/add_division')?>"><span>Create Division</span></a></li>  
  		</ul>
	</div>
</legend>
