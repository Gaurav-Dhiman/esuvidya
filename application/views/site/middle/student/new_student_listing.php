...
?>	
	...
	$(document).ready(function(){
		...
		$('#tbl_viewallstudent').dataTable({
		    ...
		    "bProcessing": true,
		    "bServerSide": true,
		    "sAjaxSource": "<?php echo base_url('student/ajax_datatable_new_student_list') ?>",
...
?>	
	<div class="portlet box blue ">
		...
		<div class="portlet-body form">
			<form action="<?php echo base_url('student/new_student_listing');?>" class="form-horizontal form-bordered form-label-stripped" method="POST">
