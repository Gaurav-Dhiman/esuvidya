...
?>
	...
	$(document).ready(function(){
		...
		$('#tbl_viewallstudent').dataTable({
		    ...
		    "bProcessing": true,
		    "bServerSide": true,
		    "sAjaxSource": "<?php echo base_url('student/ajax_datatable_student_by_caste_list') ?>",
	...
	<!-- HEADER  -->
	<legend>Student By Caste Listing	
...
?>	
	<div class="portlet box blue ">
		...
		<div class="portlet-body form">
			<form action="<?php echo base_url('student/student_by_caste_listing');?>" class="form-horizontal form-bordered form-label-stripped" method="POST">
