...
<body class="page-header-fixed">
	...
	<script src="<?php echo base_url('assets/plugins/jquery-migrate-1.2.1.min.');?> type="text/javascript"></script>
	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->
	<script src="<?php echo base_url('assets/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.');?> type="text/javascript"></script>      
	<script src="<?php echo base_url('assets/plugins/bootstrap/js/bootstrap.min.');?> type="text/javascript"></script>
	<!--[if lt IE 9]>
	<script src="<?php echo base_url('assets/plugins/excanvas.min.');?>></script>
	<script src="<?php echo base_url('assets/plugins/respond.min.');?>></script>  
	<![endif]-->   
	<script src="<?php echo base_url('assets/plugins/jquery-slimscroll/jquery.slimscroll.min.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jquery.blockui.min.');?> type="text/javascript"></script>  
	<script src="<?php echo base_url('assets/plugins/jquery.cookie.min.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/uniform/jquery.uniform.min.');?> type="text/javascript" ></script>
	<!-- END CORE PLUGINS -->
	<!-- BEGIN PAGE LEVEL PLUGINS -->
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/jquery.vmap.');?> type="text/javascript"></script>   
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.');?> type="text/javascript"></script>  
	<script src="<?php echo base_url('assets/plugins/flot/jquery.flot.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/flot/jquery.flot.resize.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jquery.pulsate.min.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/bootstrap-daterangepicker/date.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/bootstrap-daterangepicker/daterangepicker.');?> type="text/javascript"></script>     
	<script src="<?php echo base_url('assets/plugins/gritter/js/jquery.gritter.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/jquery.sparkline.min.');?> type="text/javascript"></script>  
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="<?php echo base_url('assets/scripts/app.');?> type="text/javascript"></script>
	<script src="<?php echo base_url('assets/scripts/index.');?> type="text/javascript"></script>        
